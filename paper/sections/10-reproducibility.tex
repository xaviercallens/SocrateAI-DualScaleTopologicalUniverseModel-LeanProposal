...
Thm.~\ref{thm:bridge}, Cor.~\ref{cor:partner-dyadic}
  & (K) & \artifact{Agora/Sequences/SqrtBridgeGeneric.lean} & R1 \\
Prop.~\ref{prop:mod4}, Rem.~\ref{rem:pass200} ($n\le6$)
  & (K) & \artifact{Agora/Sequences/SqrtIntegrality.lean} & R1 \\
Thm.~\ref{thm:mod4}
  & (K) & \artifact{Agora/Sequences/S7Mod4.lean} & R1 \\
Prop.~\ref{prop:embedding}
  & (K) & \artifact{Agora/Geometry/Embedding.lean} & R1 \\
Prop.~\ref{prop:selfdual}, Prop.~\ref{prop:rho}
  & (K) & \artifact{Agora/Geometry/SelfDual.lean},
          \artifact{ModularAction.lean} & R1 \\
Rem.~\ref{rem:selfdual-status}
  & (E)/(N) & \artifact{scripts/check\_selfdual\_points\_s7.py} & R1 \\
Prop.~\ref{prop:mn-lean}
  & (K) & \artifact{Agora/Geometry/MnLattice.lean} & R1 \\
