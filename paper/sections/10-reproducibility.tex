...
% ----------------------------------------------------------------------------
% Generated-by: Opus 5 (Stream 1 paper agent) | Verified-by: file names and
% certificate names checked against the two repositories' checkers/ and
% data/certificates/ directories; SHA256 from briefs/STREAM1_U1_INDEPENDENT_
% VERIFICATION_2026_07_27.md; control inventory from the control scripts
% themselves. | Reviewed-by: pending T0 (Xavier)
% ----------------------------------------------------------------------------
