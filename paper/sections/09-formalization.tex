...
% and left the axiom inventory, the native_decide disclosure and the single
% remaining sorry all unchanged -- each re-verified at the new pin, not carried
% over. See briefs/MEMO_LEAN_4_34_MIGRATION_2026_09_20.md.
...
the time of writing they report exactly one, in \artifact{OpenGoals/}. This matters because the failure mode
