...
is not verified anywhere in this paper.
...
% ----------------------------------------------------------------------------
% Generated-by: Opus 5 (Stream 1 paper agent) | Verified-by: framework
% statements vs paper/references.bib entries Dolgachev1996 / Doran2000 as
% recorded in PLAN.md row #19; rho=19 / T=3 conditionality and the (H1)/(H2)
% split vs Stream 2 data/certificates/L3_IRREDUCIBLE.json step5_hodge_
% identification + conditional_on_step5; overlattice and rescaling ambiguities
% vs C2_cooper_s7_v4.json and briefs/STREAM2_U1_EXECUTION_2026_07_27.md §4.
