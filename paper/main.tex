...
% \S11 Acknowledgments added 2026-07-29 by Sonnet 5 (WP-P1) | Verified-by:
% pdflatex+bibtex build, claims traced per paper/PLAN.md #3 (row 21 added for
% G0) | Reviewed-by: pending T0 (Xavier)
% ---------------------------------------------------------------------------
