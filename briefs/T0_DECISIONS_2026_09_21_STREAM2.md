> **Delivered copy (untracked) — source of truth: Stream 2 repo, `briefs/T0_DECISIONS_2026_09_21_STREAM2.md`, branch stream2/t0-rho20-adopted-2026-09-21 @ 16c20a4 (PR open, not yet merged). Dropped here by the Stream 2 session on 2026-09-21; not committed — the owning session decides.**
